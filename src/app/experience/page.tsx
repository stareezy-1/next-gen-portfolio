...
export const metadata: Metadata = {
  title: "Experience",
  description:
    "Professional experience of Muhammad Bintang Al Akbar, Front-End and AI-Native Engineer. Four years across React, React Native, Expo, TypeScript, and the Cloudflare edge.",
